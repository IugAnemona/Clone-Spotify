        ...
        return (
            <main id='home'>
                <div className='flex flex-col justify-center text-center py-72 
                 px-4 bg-spotify-theme-mobile md:bg-spotify-theme lg:bg-spotify-theme bg-banner-mobile md:bg-banner bg-195% md:bg-295% lg:bg-banner lg:bg-175% bg-purple-main text-green-main'>
